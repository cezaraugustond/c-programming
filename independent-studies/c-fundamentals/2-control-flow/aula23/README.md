...
- [Prática 1](./pratica1.c) Desenvolva um algoritmo que incremente um valor inicial até um valor final definido pelo usuário. O programa deve solicitar ao usuário a digitação de dois números inteiros (valor inicial e valor final), utilizar a estrutura de repetição `while` para realizar o incremento e exibir cada valor na tela. O programa deve utilizar o comando `continue` para **pular a exibição do número 7**, sem interromper a execução do laço.